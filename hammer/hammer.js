...
var TouchInput = function (_Input) {
  ...
  createClass(TouchInput, [{
    ...
    key: 'hasTargetId',
    value: function hasTargetId(id) {
      return !!this.targetIds[id];
    }
  }, {
    key: 'setTargetId',
    value: function setTargetId(id) {
      this.targetIds[id] = true;
    }
  }, {
    key: 'removeTargetId',
    value: function removeTargetId(id) {
...
function getTouches(ev, type) {
  ...
  var isOnlyTouch = type & (INPUT_START | INPUT_MOVE) && allTouches.length === 1;

  return isOnlyTouch ? getTouchesWhenSingleTouch(this, allTouches) : getTouchesWhenMultiTouch(this, allTouches, toArray$1(ev.changedTouches), type);
}

function getTouchesWhenSingleTouch(input, allTouches) {
  var targetIds = input.targetIds;
...
function getTouchesWhenMultiTouch(input, allTouches, changedTouches, type) {
  ...
  var targetTouches = getTouchesInTarget(allTouches, target);
  var changedTargetTouches = void 0;
...
function getTouchesInTarget(touches, target) {
  return touches.filter(function (touch) {
...
var MouseInput = function (_Input) {
  ...
  function MouseInput() {
    ...
    MouseInput.prototype.evEl = MOUSE_ELEMENT_EVENTS;
    MouseInput.prototype.evWin = MOUSE_WINDOW_EVENTS;
...
var Manager = function () {
  ...
  createClass(Manager, [{
    ...
    key: 'savePrevInput',
    value: function savePrevInput(input) {
